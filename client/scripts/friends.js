var Friends = {
  friendList: {},
  toggleStatus: function (friendName) { // setting friend status as object and its value as boolean
  ...
  updateFriendList: function (friendName) { // checks above status and adds or removes class for highlight
