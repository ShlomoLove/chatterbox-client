var RoomsView = {
  ...
  initialize: function () {
    ...
    RoomsView.$addRoom.on("click", function (event) { // start up new room and add room
    ...
    RoomsView.$go.on("click", function (event) { // empties curr chatroom & repopulates with filtered messages
